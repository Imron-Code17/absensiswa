...
class AddKelasView extends GetView<AddKelasController> {
  const AddKelasView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            homeC.kelasM.insertKelas(Kela(
                kelas: controller.kelasC.text, desc: controller.desC.text));
